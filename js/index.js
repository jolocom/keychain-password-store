...
var KeyChain = /** @class */ (function () {
    ...
    KeyChain.prototype.savePassword = function (password) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.nativeLib.setGenericPassword(this.username, password)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    KeyChain.prototype.getPassword = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.nativeLib.getGenericPassword()];
                    case 1:
                        result = _a.sent();
